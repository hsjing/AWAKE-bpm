...
#
#  File     mb_system_setup.tcl (Mon Mar 07 16:24:29 2016)
#
...
#  with the '-tclbatch mb_system_setup.tcl' option.
...
proc PrintHelpInformation {} {
  ...
  puts "**********************************************************************"
  puts "***"
  puts "***   Simulation Setup Macros (mb_system_setup.tcl)"
  puts "***"
  puts "***   w   =>  set up signal tracing for the ISE Simulator waveform"
  puts "***           viewer (edit signal lists in mb_system_wave.tcl)"
  puts "***"

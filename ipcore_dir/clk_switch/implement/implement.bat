...
xst -ifn xst.scr
move clk_switch_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\clk_switch.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clk_switch.ucf clk_switch_exdes

echo 'Running map'
map -timing -pr b clk_switch_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm clk_switch_exdes -w routed.ncd routed.v
cd ..
